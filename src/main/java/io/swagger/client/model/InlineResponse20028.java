...
import io.swagger.client.model.InlineResponse20028Rows;
...
public class InlineResponse20028 {
  @SerializedName("rows")
  private List<InlineResponse20028Rows> rows = null;

  @SerializedName("total")
  private Integer total = null;

  public InlineResponse20028 rows(List<InlineResponse20028Rows> rows) {
    this.rows = rows;
    return this;
  }

  public InlineResponse20028 addRowsItem(InlineResponse20028Rows rowsItem) {
    if (this.rows == null) {
      this.rows = new ArrayList<InlineResponse20028Rows>();
    }
  ...
  **/
  @Schema(description = "")
  public List<InlineResponse20028Rows> getRows() {
    return rows;
  }

  public void setRows(List<InlineResponse20028Rows> rows) {
    this.rows = rows;
  }

  public InlineResponse20028 total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.rows, inlineResponse20028.rows) &&
        Objects.equals(this.total, inlineResponse20028.total);
  }
