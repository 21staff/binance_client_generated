...
public class ApiClient {
    ...
    private String basePath = "https://virtserver.swaggerhub.com/21staff/Binance/1.0.0";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKey", new ApiKeyAuth("header", "X-MBX-APIKEY"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://virtserver.swaggerhub.com/21staff/Binance/1.0.0
